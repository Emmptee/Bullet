package com.souha.bullet.base.viewmodel;
...
public class BaseViewModel extends BaseObservable {
    ...
    protected <T> void setDataObject(ObservableBoolean isEmpty, T object, ObservableField<T> field) {
    ...
    protected  <T> void setDataList(ObservableBoolean isEmpty, List<T> list, ObservableList<T> observableList) {
        if (isEmpty == null || observableList == null) {
            return;
        }
